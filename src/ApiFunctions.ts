...
import { Features, APICallGeoLocation,  HistoricalWeatherDataType} from './Types/APICallTypes'

export const findHistoricalWeather = async (latitude: string, longitude: string, tempDisplay: string, yearValue: number): Promise<HistoricalWeatherDataType> => {
    try{
